...
import { type Member, isTeamMember } from "./_components/MemberCard";
...
const personas = [
  {
    ...
    title: "Operators",
    subtitle:
      "Hotels, Short-Term Rental Hosts, Property Managers, Tour Operators, Attractions, Experience Providers, DMCs",
    message:
      "You want more direct bookings. Less dependency on platforms. Control of your own business and destiny.",
    benefits: [
  ...
  },
  {
    ...
    title: "Tech & Services",
    subtitle:
      "PMS, Booking Engines, Channel Managers, Analytics Platforms, AI Tools for Operators, Consultants, Agencies, Revenue Managers, Marketing Strategists",
    message:
      "Your clients want more direct bookings. Show them you support their mission.",
    benefits: [
  ...
  },
  {
    ...
    subtitle:
      "Booking Marketplaces, Metasearch Engines, Travel Apps, Travel Websites, AI Travel Assistants, Listing Sites, Price Comparison Tools, Travel Discovery Platforms",
    message:
      "You're building a new kind of distribution. One that doesn't extract — it empowers.",
    benefits: [
  ...
  },
  {
    ...
    subtitle:
      "Trade Associations, DMOs/CVBs, Tourism Boards, Regional Alliances, Industry Conferences, Professional Networks",
    message:
      "Your members are asking how to drive direct bookings. Here's how you help them.",
    benefits: [
  ...
  },
  {
    ...
    subtitle:
      "Travel Publishers, Travel Blogs, Travel Newsletters, Travel Influencer Brands, Travel Content Creators",
    message:
      "You shape the conversation around travel. Help amplify the direct booking movement.",
    benefits: [
...
const faqs = [
  {
    ...
    answer:
      "A coalition of travel operators, tech companies, industry organizations, and individuals united around promoting direct bookings in the travel industry. We're building an ecosystem where value stays with those who create travel experiences.",
  },
  {
    question: "What is Kicbak?",
    answer:
      "Kicbak is our first initiative—a network where operators share guests directly instead of losing them to OTAs. Operators can give guests rewards at no cost, own their guests across the network forever, and earn revenue when those guests book elsewhere in the network.",
  },
  {
    question: "Who can join?",
    answer:
      "Anyone who supports the mission of promoting direct bookings. Travel operators (hotels, vacation rentals, tours, experiences), travel tech companies, industry organizations, and individual practitioners are all welcome.",
  },
  {
    question: "Is this anti-OTA?",
    answer:
      "No. OTAs provide value—selection, convenience, trust. We believe in balance and choice. We're building an alternative ecosystem, not attacking what exists. Operators deserve options.",
  },
  {
    question: "What do I get as a member?",
    answer:
      "A profile in our member directory, visibility within the alliance, connection to others building the direct booking ecosystem, and early access to Kicbak when it launches.",
  },
  {
...
export default function Home() {
  ...
  const [featuredMembers, setFeaturedMembers] =
    useState<Member[]>(initialMembers);
  const [featuredMembersRow2, setFeaturedMembersRow2] =
    useState<Member[]>(initialMembers);
        ...
        <div className="container">
          <div className="hero-content">
            <h1 className="hero-title">
              ...
              <span className="hero-line hero-title-accent-secondary">
                Get Discovered.
              </span>{" "}
              <span className="hero-line hero-title-accent">Get Connected.</span>
            </h1>
            <p className="hero-subtitle">
              The Direct Booking Alliance is an open industry association for
              everyone who supports the direct booking ecosystem.
            </p>
            ...
            {featuredMembers.length > 0 && (
              <div className="social-proof-section hero-social-proof">
                <p className="social-proof-heading">
                  Join{" "}
                  <span className="social-proof-count">{totalMemberCount} members</span>{" "}
                  building the direct booking future.
                </p>
                <div
                  className="social-proof-marquee"
                  style={
                    { "--marquee-duration": `${marqueeDuration}s` } as import("react").CSSProperties
                  }
                >
      ...
      <section className="section-white">
        <div className="container">
          <div className="section-header">
            ...
            <p>
              The system is stacked against independent operators. Here&apos;s
          ...
          <div className="problems-grid">
            <div className="problem-card">
              ...
              <p>
                Competing against platforms with massive reach, billions in ad
                spend, and deep network effects is an uphill battle for any
                individual operator.
              </p>
            </div>
            ...
            <div className="problem-card">
              ...
              <p>
                Travelers explore new destinations. Their lifetime value walks
                out the door — and straight back to the OTA for their next trip.
              </p>
            </div>
            ...
            <div className="problem-card">
              ...
              <p>
                Commissions flow to platforms instead of staying with operators.
                The industry subsidizes its own disruption.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="mission-content">
            ...
            <p className="mission-statement">
              We are a coalition of travel operators, tech & services providers,
              consumer platforms, industry organizations, creators & media, and
              allies building an ecosystem where{" "}
              <strong>value stays with those who create it.</strong>
            </p>
            <div className="mission-pillars">
              <div className="mission-pillar">
                ...
                <p>
                  Everything we build serves the operator. Not the platform. Not
                  the middleman.
                </p>
              </div>
              <div className="mission-pillar">
      ...
      <section className="section-purple initiatives-section">
        <div className="container">
          <div className="section-header">
            ...
            <p>
              Concrete tools and programs designed to shift the balance of power back to operators.
            </p>
          </div>
          ...
          <div className="initiatives-grid">
            ...
            <div className="initiative-card">
              ...
              <div className="initiative-coming-soon">
                ...
                <span>
                  Details coming soon —{" "}
                  <Link href="/join" style={{ color: "var(--purple-600)", fontWeight: 600 }}>
                    join the Alliance
                  </Link>{" "}
                  to stay updated
                </span>
      ...
      <section className="section-white personas-section">
        <div className="container">
          <div className="section-header">
            ...
            <p>
              Join the growing community of operators, tech & services providers, consumer platforms,
              industry organizations, and creators & media building the direct booking future.
            </p>
          </div>
          ...
          <div className="persona-display">
            <div className="persona-display-content">
              ...
              <div className="persona-display-right">
                <div className="persona-display-icon">{personas[activePersona].icon}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="cta-content">
            <span
              ...
              style={{ background: "rgba(255,255,255,0.1)", color: "var(--purple-200)" }}
            >
              Get Started
            </span>
            <h2>Ready to Join the Movement?</h2>
            <p>
              Be part of the alliance building the future of direct bookings in travel. Membership is free.
